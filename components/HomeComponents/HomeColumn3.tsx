...
const Column3 = () => {
  ...
  return (
    <div className="min-h-screen flexcolcenter">
      ...
      <div
        className={`max-w-[800px] flex flex-col justify-center items-center md:grid md:grid-cols-2 w-full gap-8 ${
      ...
      >
        <div className="WhiteCard blur-thig-3xl justify-start skew-y-0 ">
          ...
          <div className="flex flex-col gap-2 px-8 pb-8">
            ...
            <p>
              But I can develop in any popular front-end frameworks like
              Angular, Svelte, and Vanilla Javascript
            </p>
            <p>
